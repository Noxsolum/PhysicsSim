...
void InitScene()
{
	...
	//materials
	PxMaterial* default_material = physics->createMaterial(0.f, 0.0f, 10.0f);   //static friction, dynamic friction, restitution
	...
	box = physics->createRigidDynamic(PxTransform(PxVec3(0.f, 1.0f, 0.f)));
